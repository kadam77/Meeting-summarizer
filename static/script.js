...
const toggleMenu = (button) => {
  ...
  button.style.backgroundColor = "#9fc7ff"; //light-green // upper-layer-background
...
const untoggleMenu = (button) => {
  ...
  button.style.backgroundColor = "#5a97ec"; //green  // background
};
...
const openMenu = () => {
  ...
  menu_logo.src = "static/photos/logo2.png";
  menu_logo.style.width = "50px";
  ...
  p_settings.innerHTML = "Something";
  ...
  logout_photo.src = "static/photos/meeting2.png";
